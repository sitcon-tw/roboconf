...
class UserProfile(models.Model):
    ...
    school = models.CharField(max_length=32, default='', help_text='school or company', blank=True, null=True)
    grade = models.CharField(max_length=32, default='', help_text='department and grade / position', blank=True, null=True)
