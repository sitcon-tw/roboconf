...
class UserProfile(models.Model):
    ...
    certificate = models.BooleanField(help_text='need for certificate', default=True)
    require_printed_cert = models.BooleanField(help_text='require printed certificate', default=False)
    cel_dinner = models.BooleanField(help_text='need for celebratory dinner', default=False)
    prev_worker = models.BooleanField(help_text='if is previously a conference staff', default=False)
    on_site = models.NullBooleanField(help_text='if is onsite volunteer', default=True, null=True)
    ...
    personal_id = models.CharField(max_length=16, default='', help_text='id number, for insurance', blank=True, null=False)
    ice_contact = models.CharField(max_length=32, default='', help_text='Emergency contact info', blank=True, null=False)
    ice_phone = models.CharField(max_length=32, default='', help_text='emergency contact number', blank=True, null=False)
    birthday = models.DateField(help_text='birthday, for insurance', blank=True, null=True)
