...
class UserProfile(models.Model):
    ...
    organization = models.CharField(max_length=64, default='', help_text='organization/community/school/company', blank=True, null=True)
    phone = models.CharField(max_length=16, default='', blank=True, null=True)
    redmine = models.CharField(max_length=32, default='', help_text='redmine id', blank=True, null=True)
    slack = models.CharField(max_length=32, default='', help_text='slack nick', blank=True, null=True)
    ...
    residence = models.CharField(max_length=32, default='', help_text='residence', blank=True, null=True)
    shirt_size = models.CharField(max_length=8, default='', help_text='T-shirt size', blank=True, null=True)
    diet = models.CharField(max_length=8, default='', blank=True, null=True)
    ...
    personal_id = models.CharField(max_length=16, blank=True, default='', null=True)
    volunteering_proof = models.NullBooleanField(help_text='need for volunteering proof application', default=False, null=True)
    volunteering_work_done = models.CharField(max_length=256, default='', help_text='work done for the conf., for volunteering proof application', blank=True, null=True)
    volunteering_duration = models.CharField(max_length=8, default='', help_text='volunteering duration, for volunteering proof application', blank=True, null=True)
    volunteering_time = models.CharField(max_length=32, default='', help_text='volunteering timespan, for volunteering proof application', blank=True, null=True)
    birthday = models.CharField(max_length=10, default='', help_text='birthday, for volunteering proof application', blank=True, null=True)
    ...
    lead_team = models.ManyToManyField(Group, help_text='leading team', default=None, null=True, blank=True, related_name='leader')
